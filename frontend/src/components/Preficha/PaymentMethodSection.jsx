  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <div onClick={() => updateFormData('metodoPago', 'transferencia')}
          className={`card cursor-pointer transition-all ${
            formData.metodoPago === 'transferencia'
              ? 'border-2 border-primary-500 bg-primary-50' : 'hover:shadow-lg'
          }`}>
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <h3 className="text-lg font-bold text-neutral-900">Transferencia Bancaria</h3>
              </div>
              ...
              {formData.metodoPago === 'transferencia' && (
                <div className="bg-white p-4 rounded-lg border-2 border-primary-200">
                  ...
                  <div className="space-y-1 text-sm text-neutral-700">
                    <p><strong>Banco:</strong> Banco Bienestar</p>
                    <p><strong>No. de Cuenta:</strong> 1999025693</p>
                    <p><strong>Beneficiario:</strong> Centro de Bachillerato Tecnológico Industrial y de Servicios No. 88</p>
                  </div>
                </div>
              )}
            </div>
        ...
        <div onClick={() => updateFormData('metodoPago', 'ventanilla')}
          className={`card cursor-pointer transition-all ${
            formData.metodoPago === 'ventanilla'
              ? 'border-2 border-primary-500 bg-primary-50' : 'hover:shadow-lg'
          }`}>
          <div className="flex items-start space-x-4">
            <input type="radio" name="metodoPago" value="ventanilla"
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <h3 className="text-lg font-bold text-neutral-900">Pago en Ventanilla</h3>
              </div>
              <p className="text-neutral-600 mb-3">
              ...
              {formData.metodoPago === 'ventanilla' && (
                <div className="bg-white p-4 rounded-lg border-2 border-green-200">
                  ...
                  <div className="space-y-1 text-sm text-neutral-700">
                    ...
                    <p className="text-yellow-700 mt-2">* Lleva tu comprobante de preficha impreso</p>
                  </div>
                </div>
              )}
            </div>
      ...
      <div className="mt-8 p-6 bg-gradient-to-r from-primary-500 to-gold-500 text-white rounded-lg">
        ...
        <ul className="space-y-2 text-sm">
          <li className="flex items-start"><span className="mr-2">•</span>
            <span>Conserva tu comprobante de pago como respaldo.</span></li>
          <li className="flex items-start"><span className="mr-2">•</span>
            <span>Una vez realizado el pago, tu preficha será validada en 24-48 horas.</span></li>
          <li className="flex items-start"><span className="mr-2">•</span>
            <span>Recibirás un correo de confirmación con tu número de folio oficial.</span></li>
        </ul>
      </div>
    </div>
  )

    ...
    <div className="min-h-screen">
      ...
      <section className="gradient-bg text-white py-20">
        <div className="container-custom text-center">
          <h1 className="text-5xl font-bold mb-6">Proyectos Destacados</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Conoce los proyectos de innovación tecnológica e impacto social desarrollados 
            por nuestros estudiantes y docentes.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card bg-blue-50">
              ...
              <p className="text-neutral-700">Proyectos Anuales</p>
            </div>
